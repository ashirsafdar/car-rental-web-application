...
const UserIcon = () => <svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="8" r="3.5" /><path d="M5 21c.7-3.4 3-5 7-5s6.3 1.6 7 5" /></svg>;
      ...
      <div className="header-inner">
        ...
        <div className="header-actions">
          ...
          <button className="login-button" onClick={handleAuthClick}>
            {user ? user.name || "User" : "Login"} <UserIcon />
          </button>
